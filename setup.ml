...
(* OASIS_START *)
(* DO NOT EDIT (digest: a62f52d08f4d2e5df15212039de5ede4) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-bin-annot"])];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "irc-client";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "irc_client_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Irc_client_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "irc_client";
                      lib_findlib_name = Some "lwt";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "irc_client_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "unix";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "irc_client"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "example2.ml"});
               Executable
                 ({
                     cs_name = "test_parser";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_parser.ml"});
               Test
                 ({
                     cs_name = "test_parser";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\227\228\rE.\169\215\255\223\212\235\128\254O\208\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
